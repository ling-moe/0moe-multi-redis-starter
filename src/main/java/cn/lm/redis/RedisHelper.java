...
/**
 * @author yukdwan@gmail.com 2020/1/14 上午11:13
 */
public class RedisHelper {
    ...
    public Boolean setExpire(String key) {
        return this.setExpire(key, RedisConstants.DEFAULT_EXPIRE, TimeUnit.SECONDS);
    }
    ...
    public String strGet(String key, long expire, TimeUnit timeUnit) {
        ...
        if (!Objects.equals(expire, RedisConstants.NOT_EXPIRE)) {
    ...
    public <T> String toJson(T object) {
        if (object == null) {
            return RedisConstants.STR_EMPTY;
        }
     ...
     * @param key key 键
     * @param object object
     * @author yukdawn@gmail.com 2018-06-11 13:46
     */
